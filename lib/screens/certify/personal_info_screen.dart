...
class PersonalInfoScreen extends BaseInfoPage {
...
class _PersonalInfoScreenState extends BaseInfoPageState<PersonalInfoScreen>
  ...
  @override
  String? get retentionInputType => '2';
  ...
  Future<void> _fetchPersonalInfo() async {
    ...
    try {
      ...
      final response = await CertifyApi().fetchPersonalInfo(
        productId: productId,
      );
  ...
  @override
  String get title => 'Identity Information';

  @override
  String get tip => AppInfoManager.productModel?.cogito.person ?? '';

  @override
  String get progressAsset => AppAssets.process1;

  @override
  String get sectionTitle => 'Identity Information';
        ...
        onTap: field.isSelect
            ? () async {
                if (field.isAddress) {
                  ...
                  setState(() => _addressValues[field.uniquely] = text);
                  return;
                }
                _clearFocus();
                final selected = await showModalBottomSheet<FormOptionModel>(
                  ...
                  isScrollControlled: true,
                  builder: (context) {
                    return AnnouncerSelectSheet(options: field.cogito);
                  },
                );
                _clearFocus();
